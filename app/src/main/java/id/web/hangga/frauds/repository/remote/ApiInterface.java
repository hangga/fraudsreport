...
public interface ApiInterface {
    ...
    /**
     * get Detil Report and Frauds list
     * @param id
     * @return
     */
    @GET("reports/{id}/frauds")
    Observable<List<ReportItem>> getReportDetil(@Path("id") int id);
    ...
    Single<ReportItem> newFrauds(@Path("id") int report_id,
    ...
    Single<ReportItem> updateFrauds(@Path("report_id") int report_id,
    ...
    Single<ReportItem> deleteFrauds(@Path("report_id") int report_id,
                                    @Path("fraud_id") int fraud_id);
}
